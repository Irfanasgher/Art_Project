...
function ArtInspiration() {
    ...
    const images = [{ text: "Renaissance", image: img1 }, { text: "Medieval", image: img2 }, { text: "Western", image: img3 }, { text: "Modern", image: img4 }, { text: "Islamic", image: img5 }, { text: "Indian", image: img6 }];
                                        ...
                                        images.map((img, index) => (
                                            <>
                                                ...
                                                {/* <div className="wrapper">
                                                    <ArcTitle text='lorem lorem ipsm ba ba' arc={330} radius={100} />
                                                </div> */}
